...
def main():
    ...
    print(stats.avg_length(parser.word_count_index, 'document1'))
    print(stats.get_words_letter_end(parser.corpus_data, 'a'))
    print(stats.get_words_letter_begin(parser.corpus_data, 'n'))
    print(stats.get_words_size(parser.corpus_data, 4))
    print(stats.compute_avg(parser.corpus_data))
    print(stats.get_words_grater_avg(parser.corpus_data, 4))
