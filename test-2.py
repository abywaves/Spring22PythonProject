...
# This is the main test script for Student B
...
def main():
    ...
    parser.corpus_data = cs.parser.read_file('text_corpus.txt')
    ...
    # parser.fake_corpus_data = cs.parser.fake_builder
    # pprint.pprint(parser.fake_corpus_data)
    ...
    # print(stats.get_largest_document(parser.fake_doc_word_index))
    # print(stats.avg_length(parser.fake_word_count_index, 'document1'))
